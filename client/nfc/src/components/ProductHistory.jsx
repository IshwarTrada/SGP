  ...
  const mockOrders = [
    {
      id: "#96459761",
      status: "COMPLETED",
      date: "Dec 30, 2024 07:52",
      total: "Rs. 80 (5 Products)",
    },
    {
      id: "#71667167",
      status: "COMPLETED",
      date: "Dec 7, 2023 23:26",
      total: "Rs. 70 (4 Products)",
    },
    {
      id: "#71667167",
      status: "COMPLETED",
      date: "Feb 2, 2022 19:28",
      total: "Rs. 250 (1 Product)",
    },
    {
      id: "#51746385",
      status: "COMPLETED",
      date: "Dec 30, 2021 07:52",
      total: "Rs. 360 (2 Products)",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="flex items-center">
        <div className="w-[1100px] flex flex-col border border-gray-200 rounded-md m-auto mt-4 bg-white pt-20 p-5">
          <div className="flex items-start p-4">
            <div className="text-uppercase font-medium text-gray-900 text-lg">
              ORDER HISTORY
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200">
            <div className="flex flex-row text-gray-700 text-sm p-4">
              ...
              <div className="flex-1 font-medium text-uppercase text-center">
                ACTION
              </div>
            </div>
          </div>
          <section className="flex flex-col mt-2">
            ...
            {orders.map((order, index) => (
              <div
                key={index}
                className="flex flex-row items-start justify-between p-2 border-b border-gray-200 text-gray-600"
              >
                <div className="flex-1 font-medium">{order.id}</div>
                <div
                  className={`flex-1 font-medium ${order.status === "COMPLETED" ? "text-green-500" : ""}`}
                >
                  {order.status}
                </div>
