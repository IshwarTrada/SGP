...
const LandingPage = () => {
  ...
  return (
    <>
      <Navi />
      <div>
        <div className="flex flex-row justify-evenly pt-[80px]">
          <div className="inline-block relative">
            <img
              src="./src/assets/landing.svg"
              className="h-[300px] w-[200] mt-[50px]"
            />
            <img
              src="./src/assets/idea.png"
              className="h-[100px] ml-[7.85rem] mt-[-19.4rem] xl:bg-transparent"
            />
            <Link to="/signup">
            ...
            <Link to="#working">
              <button className="w-[200px] h-[53px] bg-[black] text-[beige] rounded-[50px] m-1">
                See how it Works
              </button>
            </Link>
          </div>
          <span>
            <img
              ...
              className="h-[500px] w-[400] ml-[80px]"
            />
          </span>
        </div>
      </div>
